...
from process import merge_gerber_layers, merge_gerber_stacks, merge_gerber_stacks_old
...
generate_gerber(segments, socket_locations, trace_width=0.254, via_diameter=0.6)
print("✅ Generated Gerber files")

# Generate Excellon files
generate_excellon(socket_locations, drill_size=0.3)
print("✅ Generated Excellon files")

# Merge the Gerber stacks, along with the new generated layers
merge_gerber_stacks_old(modules)
