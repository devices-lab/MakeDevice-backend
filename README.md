...
```sh
/home/ben/Documents/MD/MakeDevice-Backend/venv/bin/python -u /home/ben/Documents/MD/MakeDevice-Backend/debug_visual_run.py --job-id MqByYfLU
```
...
Replace `MqByYfLU` with your job ID, or omit `--job-id` to use the most recent job in `storage/jobs/`.
